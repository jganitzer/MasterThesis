...
from transformers import  DataCollatorForLanguageModeling, MegaForMaskedLM
...
file_path = dataRoot + heritability + '/train/snp_X_train_maf_fine_token.txt'
...
data_collator = DataCollatorForLanguageModeling(
    tokenizer=tokenizer, mlm=True, mlm_probability=mlm_probability, pad_to_multiple_of = chunk_size
)

dataset = GenomicDataset(file_path, max_length = paddedLength, tokenizer = tokenizer, use_padding = True)
