...
from models.hyenaEncoder import HyenaRegressor_MLP_cat
...
file_path_train = dataRoot + heritability + '/train/snp_X_train_maf_fine_token.txt'
label_path_train = dataRoot + heritability + '/train/snp_y_train_maf_fine_token.parquet'

file_path_test = dataRoot + heritability + '/test/snp_X_test_maf_fine_token.txt'
label_path_test = dataRoot + heritability + '/test/snp_y_test_maf_fine_token.parquet'
