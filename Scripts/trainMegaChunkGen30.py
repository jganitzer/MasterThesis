...
from utils.torchDataloader import OneHotMaskLoaderFine
...
oneHotLoader = OneHotMaskLoaderFine(dataRoot + heritability, trainPath, testPath, wandbDir=wandbDir, batch_size = batch_size, paddedLength = paddedLength)
