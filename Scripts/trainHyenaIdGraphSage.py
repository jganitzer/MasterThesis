...
# load data
data = torch.load(dataRoot + heritability + "/graph_maf_float32_cat.pt")
...
model = HyenaGraphSage_3MLP_Reduced(input_dim=input_dim, in_channels = data.x.size(1), hidden_channels = embed_dim, 
